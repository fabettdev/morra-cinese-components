...
var _fightinhIconStyle = require("./fightinhIconStyle");
...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // React
// Style
// React Native
  ...
  (0, _react.useEffect)(function () {
    ...
    var interval = setInterval(function () {
      setState(function (prevState) {
        var isReturning = prevState.isReturning;
        var rotate = null;
        var translate = null;
